...
const RightPanel: React.FC<RightPanelProps> = ({ document, onRunTool, currentResult, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Panel Container */}
      <div className={`
        fixed inset-y-0 right-0 z-40 w-full sm:w-[450px] bg-slate-950 border-l border-slate-800 flex flex-col h-full shrink-0 transition-transform duration-300 ease-in-out
        md:relative md:translate-x-0 md:w-[450px] md:z-20
        ${isOpen ? 'translate-x-0' : 'translate-x-full'}
      `}>
        {/* Mobile Header with Close */}
        <div className="flex items-center justify-between p-4 border-b border-slate-800 md:hidden">
          <h2 className="font-bold text-white">AI Toolkit</h2>
